        ...
        <section className={`${style.section2}`}>
            ...
            <div className={style.info_mother}>
                ...
                <div  className={`${style.info} ${style.first_and_third}`}>
                    <div ><span className={`inter-bold`}>Email</span><br/>shaomanlee@gs.ncku.edu.tw</div>
                ...
                <div  className={`${style.info} ${style.second_and_fourth}`}>
                    <div ><span className={`inter-bold`}>Phone</span><br/>+886 2757575 &nbsp;&nbsp; #80980</div>
                ...
                {/* take out margin and let the two elements space-between (when < 500px, one column) */}
                <div  className={`${style.info} ${style.first_and_third}`}>
                    <div><span className={`inter-bold`}>GitHub</span><br/>https://github.com/Sociolegal-Lab</div>
                ...
                <div  className={`${style.info} ${style.second_and_fourth}`}>
                    ...
                    <div><span className={`inter-bold`}>Address</span><br/>Miin Wu School of Computing<br/>No.1, University Road, Tainan City 701, Taiwan</div>    
