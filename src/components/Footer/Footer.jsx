...
function Footer(){
    ...
    <footer className={style.footer}>
        ...
        <section className="inter-bold">
            ...
            <div className={style.info_mother}>
                ...
                <div  className={`${style.info} ${style.first_and_third}`}>
                    <div >EMAIL<br/>shaomanlee@gs.ncku.edu.tw</div>
                ...
                {/* take out margin and let the two elements space-between (when < 500px, one column) */}
                <div  className={`${style.info} ${style.first_and_third}`}>
                    <div>GITHUB URL<br/>https://github.com/Sociolegal-Lab</div>
                    <button type="button" onClick={()=>openNewTab("https://github.com/Sociolegal-Lab", "https://github.com/Sociolegal-Lab")}>
                ...
                <div  className={`${style.info} ${style.second_and_fourth}`}>
                    ...
                    <button type="button" onClick={()=>openNewTab("https://maps.app.goo.gl/5aCHHit2uuUqx8tn7")}>
        ...
        <section className={`inter-medium ${style.fine}`} >
            ...
            <a style={{textDecoration: 'underline',}}>Design Credit</a>
        </section>
